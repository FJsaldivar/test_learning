...
/// A placeholder cell to use while loading information
public final class DefaulAbraPlaceholderCell: AbraPlaceholderCell {
    ...
    public override func configurePlaceholder(theme: Theme = AbraThemeManager.theme) {
...
extension DefaulAbraPlaceholderCell: RegistrableCell, AutomaticSizedCell {
