...
/// The base placeholder cell to use while loading information
open class AbraPlaceholderCell: UITableViewCell {
    ...
    /// Use this function to configure the cell and animate the layer
    open func configurePlaceholder(theme: Theme = AbraThemeManager.theme) {
        configureCell()
