...
final class DefaultUIFareCellModelProvider: AbraCellModelFactory {
    func model(theme: Theme,
               typographyProvider: ThemeTypographyProvider,
               type: AbraCellType) -> AbraCellThemedModel {
    ...
    private func cellIcon(for indicator: AbraCellIndicator?, cellType: AbraCellType) -> AbraCellIconType? {
    ...
    private func cellTheme(movementCellStatus: AbraMovementCellStatus?,
                           theme: Theme,
                           typographyProvider: ThemeTypographyProvider,
                           type: AbraCellType) -> AbraCellTheme {
        
        guard let movementCellStatus = movementCellStatus, movementCellStatus != .none else {
            return DefaultAbraCellTheme(titleColor: theme.color(for: .neutralDarker),
        ...
        return DefaultAbraCellTheme(leftTitleColor: theme.color(for: .neutralDarker),
    ...
    private func actionButtonAlignment(for type: AbraCellType) -> UIStackView.Alignment {
        switch type {
        case .movement:
            return .center
        default:
    ...
    private func iconAlignment(for type: AbraCellType) -> UIStackView.Alignment {
        switch type {
        case .movement:
            return .center
        default:
    ...
    private func iconTintColor(type: AbraCellType, theme: Theme) -> UIColor? {
        switch type {
        case .simpleNonActionable, .simpleActionable, .switchButton, .tag, .chevron:
