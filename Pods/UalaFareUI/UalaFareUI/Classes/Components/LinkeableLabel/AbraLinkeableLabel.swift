...
/// A label that supports multiple links
final public class AbraLinkeableLabel: UILabel {
    ...
    /// The delegate gets notified when a user taps a link
    public weak var delegate: AbraLinkeableLabelDelegate?
    ...
    /// Add multiple links to the label
    ...
    private func configureLinkedText() {
        ...
        let linkColor = AbraThemeManager.theme.color(for: .primaryDefault)
    ...
    private func openTappedLinkIfValid(tapPoint: CGPoint, allText: String, delegate: AbraLinkeableLabelDelegate) {
