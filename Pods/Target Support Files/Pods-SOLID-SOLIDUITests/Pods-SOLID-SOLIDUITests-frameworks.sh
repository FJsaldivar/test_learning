...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UalaAnalytics/UalaAnalytics.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UalaAuth/UalaAuth.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UalaCore/UalaCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UalaFareUI/UalaFareUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UalaNetwork/UalaNetwork.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UalaUI/UalaUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UalaUtils/UalaUtils.framework"
